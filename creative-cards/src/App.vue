  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-12">
        ...
        <transition appear appear-active-class="custom-appear-active-class" name="fade" mode="out-in" @enter="enter">
          <keep-alive>
...
import CardInsideLeft from './components/cards/CardInsideLeft.vue'
import CardInsideRight from './components/cards/CardInsideRight.vue'
